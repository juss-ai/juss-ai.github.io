...
<div id='fg_formContainer'>
    <div id="fg_container_header">
        <div id="fg_box_Title">Kontakt oss</div>
    ...
    <div class='container'>
        <label for='name' >Fornavn og etternavn*: </label><br/>
    ...
    <div><img alt='Captcha image' src='show-captcha.php?rand=1' id='scaptcha_img' /></div>
        <label for='scaptcha' >Skriv koden under:</label>
        <input type='text' name='scaptcha' id='scaptcha' maxlength="10" /><br/>
        <span id='contactus_scaptcha_errorloc' class='error'></span>
        <div class='short_explanation'>Vanskelig å lese bildet?
        <a href='javascript: refresh_captcha_img();'>Klikk her for å generere nytt bilde</a>.</div>
    </div>
